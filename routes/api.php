...
// Rotas públicas para eventos (para teste)
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('eventos')->group(function () {
        ...
        Route::get('/proximos', [EventoController::class, 'proximos']);
        Route::get('/categorias', [EventoController::class, 'categorias']);
    ...
    // Rotas para Postagens (admin pode moderar)
    Route::prefix('postagens')->group(function () {
        ...
        Route::middleware('role:admin')->group(function () {
            Route::patch('/{id}/fixar', [PostagemController::class, 'fixar']);
            Route::patch('/{id}/desfixar', [PostagemController::class, 'desfixar']);
            Route::patch('/{id}/aprovar', [PostagemController::class, 'aprovar']);
            Route::patch('/{id}/rejeitar', [PostagemController::class, 'rejeitar']);
        });
    });
